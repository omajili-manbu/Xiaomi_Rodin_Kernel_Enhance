...
static const char *const rodin_builtin_modules[] = {
	...
	"clk_bringup",
#endif
#if IS_ENABLED(CONFIG_COMMON_CLK_MT6899)
	"clk_chk_mt6899",
#endif
#if IS_ENABLED(CONFIG_DEVICE_MODULES_COMMON_CLK_MEDIATEK)
	"clk_common",
#endif
#if IS_ENABLED(CONFIG_DEVICE_MODULES_ALLOW_BUILTIN)
	"clk_dbg_mt6899",
	...
	"device_apc_common",
#endif
#if IS_ENABLED(CONFIG_DEVAPC_MT6899)
	"device_apc_mt6899",
#endif
#if IS_ENABLED(CONFIG_DEVICE_MODULES_ALLOW_BUILTIN)
	"ftdi_sio",
	...
	"mtk_mbox",
#endif
#if IS_ENABLED(CONFIG_MTK_TINYSYS_MBOX)
	"mtk_mbox_mailbox",
#endif
#if IS_ENABLED(CONFIG_DEVICE_MODULES_MTK_SCPSYS)
	"mtk_pm_domain_disable_unused",
#endif
#if IS_ENABLED(CONFIG_DEVICE_MODULES_ALLOW_BUILTIN)
	"mtk_rpmsg_mbox",
#endif
	...
	"mtk_tinysys_ipi",
#endif
#if IS_ENABLED(CONFIG_DEVICE_MODULES_MEDIATEK_WATCHDOG)
	"mtk_wdt",
#endif
#if IS_ENABLED(CONFIG_DEVICE_MODULES_ALLOW_BUILTIN)
	"nfc",
	...
	"pd_chk_mt6899",
#endif
#if IS_ENABLED(CONFIG_PINCTRL_MT6899)
	"pinctrl_mt6899",
#endif
#if IS_ENABLED(CONFIG_DEVICE_MODULES_ALLOW_BUILTIN)
	"pinctrl_mtk_common_v2_debug",
#endif
#if IS_ENABLED(CONFIG_DEVICE_MODULES_ALLOW_BUILTIN)
	"ppp_deflate",
#endif
	...
	"slhc",
#endif
#if IS_ENABLED(CONFIG_DEVICE_MODULES_DMABUF_HEAPS_SYSTEM)
	"system_heap",
#endif
	...
	"teeperf",
#endif
#if IS_ENABLED(CONFIG_DEVICE_MODULES_MTK_PMIC_WRAP)
	"mtk_pmic_wrap",
#endif
